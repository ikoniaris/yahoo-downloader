...
DROP TABLE IF EXISTS `sp500_2015`;
CREATE TABLE `sp500_2015` (
  ...
  UNIQUE KEY `ix_company_name` USING BTREE (`company_name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='List of Companies';

INSERT INTO `sp500_2015` (`company_id`, `company_name`) VALUES
